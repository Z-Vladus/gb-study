...
public class homework4 {
     ...
     *
     * @return
     * возвращает 0 - игра не окончена, 1 - победил человек, 2 - победил робот 3- ничья
     */
    ...
    public static int checkWinFullSquare() {
        ...
        // и по второй диагонали
        buf=map[0][SZ-1];
        winFlag=true;
        for (int i = SZ-1; i <= 0; i--) {
            for (int j = SZ-1; j <= 0; j--) {
                if ((map[i][j]!=buf)&&(i+j)==2) {
                    winFlag=false;
                }
            }
        }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            switch (checkWinFullSquare()) {
                case 0 -> {System.out.println("game on"); break;}
                case 1 -> {System.out.println("human wins"); break;}
                case 2 -> {System.out.println("robot wins"); break;}
        ...
        humanTurn();
        printMap();
        System.out.println(""+checkWinFullSquare());
        humanTurn();
        printMap();
        System.out.println(""+checkWinFullSquare());
        humanTurn();
