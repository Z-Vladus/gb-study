...
public class Homework7App {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            if (j < 5) {
                mammals[i] = new ru.geekbrains.lesson6.homework6.Cat();
                ru.geekbrains.lesson6.homework6.Cat loopCat = (ru.geekbrains.lesson6.homework6.Cat) mammals[i];
                System.out.println("New cat! Name= " + loopCat.getCatName());
            } else {
                mammals[i] = new ru.geekbrains.lesson6.homework6.Dog();
                ru.geekbrains.lesson6.homework6.Dog loopDog = (ru.geekbrains.lesson6.homework6.Dog) mammals[i];
