package ru.geekbrainsLev2.Lesson1.homework;
...
public class Training {
    public static void main(String[] args) {
        ...
        ru.geekbrainsLev2.Lesson1.homework.Wall[] walls = new ru.geekbrainsLev2.Lesson1.homework.Wall[10];
        // создаём беговые дорожки
        ru.geekbrainsLev2.Lesson1.homework.RunLine[] runLines = new ru.geekbrainsLev2.Lesson1.homework.RunLine[10];
        ...
        for (int i = 0; i < walls.length ; i++) {
            walls[i] = new ru.geekbrainsLev2.Lesson1.homework.Wall();
        ...
        for (int i = 0; i < runLines.length ; i++) {
            runLines[i] = new ru.geekbrainsLev2.Lesson1.homework.RunLine();
